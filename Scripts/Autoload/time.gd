...
##
## > 90.0 minutes (5400 seconds) in game == 1 second in real time
##    3.5 minutes (225 seconds)
const IN_GAME_SECONDS_PER_REAL_TIME_SECONDS: int = 5225 #5,400 == 1s
...
var state_transition_seconds: int = 28800 #3600
